...
public class TravelsMaximumStopsView extends AbstractView {
    ...
    public void draw() {
        ...
        view.append("**********************************************" + "\n");
        view.append("********    Travels Maximum Stops   **********" + "\n");
        ...
        view.append("3. The format must be : townFrom(A-Z)townUntil(A-Z)maximumStops(0-9). Example: AC5 " + "\n");
        view.append("______________________________________________" + "\n");
        view.append("______________________________________________" + "\n");
    ...
    public void getInput() {
        while (true) {
            ...
            try {
                ...
                IOption option = new MaxStopsController(input, graph);
                messageOutput = new StringBuilder();
                messageOutput.append("The numbers of travels with your maximum stops are : ");
